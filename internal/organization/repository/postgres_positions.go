...
func (r *PostgreSQLRepository) GetPositions(ctx context.Context, tenantID uuid.UUID, filter *dto.PositionFilterInput, pagination *dto.PaginationInput, sorting []dto.PositionSortInput) (*dto.PositionConnection, error) {
	page := int32(1)
	pageSize := int32(25)
	if pagination != nil {
...
LIMIT $%d OFFSET $%d`, whereClause, orderClause, argIndex, argIndex+1)
	...
	connection := &dto.PositionConnection{
		EdgesField: edges,
		DataField:  positions,
...
func (r *PostgreSQLRepository) GetPositionByCode(ctx context.Context, tenantID uuid.UUID, code string, asOfDate *string) (*dto.Position, error) {
...
func (r *PostgreSQLRepository) GetPositionTimeline(ctx context.Context, tenantID uuid.UUID, code string, startDate, endDate *string) ([]dto.PositionTimelineEntry, error) {
	args := []interface{}{tenantID.String(), strings.TrimSpace(code)}
	argIndex := 3
...
func (r *PostgreSQLRepository) GetVacantPositions(ctx context.Context, tenantID uuid.UUID, organizationCode *string, positionType *string, includeSubordinates bool) ([]dto.Position, error) {
	args := []interface{}{tenantID.String()}
	argIndex := 2
...
func (r *PostgreSQLRepository) GetPositionHeadcountStats(ctx context.Context, tenantID uuid.UUID, organizationCode string, includeSubordinates bool) (*dto.HeadcountStats, error) {
	var (
		orgName  string
		codePath string
	)
...
func (r *PostgreSQLRepository) GetPositionVersions(ctx context.Context, tenantID uuid.UUID, code string, includeDeleted bool) ([]dto.Position, error) {
	args := []interface{}{tenantID.String(), strings.TrimSpace(code)}
	whereParts := []string{"p.tenant_id = $1", "p.code = $2"}
	if !includeDeleted {
...
func (r *PostgreSQLRepository) GetVacantPositionConnection(ctx context.Context, tenantID uuid.UUID, filter *dto.VacantPositionFilterInput, pagination *dto.PaginationInput, sorting []dto.VacantPositionSortInput) (*dto.VacantPositionConnection, error) {
	args := []interface{}{tenantID.String()}
	argIndex := 2
	whereParts := []string{
		"p.tenant_id = $1",
...
`, baseCTE, selectionWhere, orderClause, limitIdx, offsetIdx)
	...
	edges := make([]dto.VacantPositionEdge, 0, len(vacants))
	...
	connection := &dto.VacantPositionConnection{
		EdgesField: edges,
		DataField:  vacants,
		PaginationField: dto.PaginationInfo{
			TotalField:       total,
...
func (r *PostgreSQLRepository) GetPositionAssignments(ctx context.Context, tenantID uuid.UUID, positionCode string, filter *dto.PositionAssignmentFilterInput, pagination *dto.PaginationInput, sorting []dto.PositionAssignmentSortInput) (*dto.PositionAssignmentConnection, error) {
	page := int32(1)
	pageSize := int32(25)
	if pagination != nil {
		if pagination.Page > 0 {
...
LIMIT $%d OFFSET $%d`, whereClause, orderClause, argIndex, argIndex+1)
	...
	edges := make([]dto.PositionAssignmentEdge, 0, len(assignments))
	...
	connection := &dto.PositionAssignmentConnection{
		EdgesField: edges,
...
func (r *PostgreSQLRepository) GetPositionAssignmentAudit(ctx context.Context, tenantID uuid.UUID, positionCode string, assignmentID *string, dateRange *dto.DateRangeInput, pagination *dto.PaginationInput) (*dto.PositionAssignmentAuditConnection, error) {
	page := int32(1)
	pageSize := int32(25)
	if pagination != nil {
		if pagination.Page > 0 {
...
`, whereClause, argIndex, argIndex+1)
	...
	for rows.Next() {
		...
		record := dto.PositionAssignmentAudit{
	...
	connection := &dto.PositionAssignmentAuditConnection{
		DataField: records,
		PaginationField: dto.PaginationInfo{
			TotalField:       total,
			PageField:        int(page),
...
func scanPositionAssignment(scanner rowScanner) (*dto.PositionAssignment, error) {
	var (
		assignmentID,
		tenantID,
		positionCode,
...
func scanVacantPosition(scanner rowScanner) (*dto.VacantPosition, error) {
	var (
		positionCode       string
...
func scanPosition(scanner rowScanner) (*dto.Position, error) {
	var (
		recordID,
		tenantID,
		code,
...
func (r *PostgreSQLRepository) populatePositionAssignments(ctx context.Context, tenantID uuid.UUID, position *dto.Position) error {
	if position == nil {
		return nil
	}
...
func (r *PostgreSQLRepository) fetchAssignmentsForPosition(ctx context.Context, tenantID uuid.UUID, positionCode string) ([]dto.PositionAssignment, error) {
