...
JWT_ALG=RS256 JWT_MINT_ALG=RS256 JWT_PRIVATE_KEY_PATH=$ROOT_DIR/secrets/dev-jwt-private.pem JWT_PUBLIC_KEY_PATH=$ROOT_DIR/secrets/dev-jwt-public.pem JWT_KEY_ID=bff-key-1 OIDC_SIMULATE=true \
