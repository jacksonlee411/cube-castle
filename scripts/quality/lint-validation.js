...
const checks = [
  ...
  {
    file: path.join(repoRoot, 'cmd', 'organization-command-service', 'internal', 'utils', 'validation.go'),
    mustInclude: [
  ...
  {
    file: path.join(repoRoot, 'cmd', 'organization-command-service', 'internal', 'repository', 'organization_hierarchy.go'),
    mustInclude: [
