...
**建立时间**: 2025-08-03  
**最后更新**: 2025年8月5日  
**迁移自**: docs/development/development-testing-fixing-standards.md  
**适用范围**: 全项目开发流程  
**负责部门**: 开发团队  

## 概述

本技术规范建立在[预防机制-重复造轮子检测](../../docs/investigations/预防机制-重复造轮子检测.md)的基础上，规范了开发、测试、修复的全流程标准，确保项目质量和架构一致性。

**重要更新**: 
- 遵循新的[文档管理规则](../implementation-guides/api-refactoring-2025/05-documentation-management-rules.md)
- 适配DOCS2统一文档架构
...
根据新建立的[文档管理规则](../implementation-guides/api-refactoring-2025/05-documentation-management-rules.md)：

- **禁止规则**: 严格禁止在 `docs/` 目录创建任何新文档
- **新文档位置**: 所有新文档必须创建于 `DOCS2/` 目录
- **文档分类**: 按照标准化的目录结构组织文档
- **版本管理**: 遵循统一的版本标记和状态管理

```bash
# ❌ 错误：在docs目录创建文档
touch docs/new-feature-spec.md

# ✅ 正确：在DOCS2创建文档
touch DOCS2/standards/new-feature-standards.md
```
...
- [预防机制-重复造轮子检测](../../docs/investigations/预防机制-重复造轮子检测.md) - 重复功能检测机制

### API相关文档 (DOCS2统一架构)
- [API设计原则](../api-specifications/api-design-principles.md) - API设计指导原则
- [员工管理API规范](../api-specifications/employees-api-specification.md) - 员工API标准
- [组织单元API规范](../api-specifications/organization-units-api-specification.md) - 组织API标准
- [职位管理API规范](../api-specifications/positions-api-specification.md) - 职位API标准

### 架构决策文档
- [ADR-002: 路由标准化](../architecture-decisions/ADR-002-route-standardization.md) - API路由规范
- [ADR-003: 员工API架构](../architecture-decisions/ADR-003-employees-api-architecture.md) - 员工API架构
- [ADR-004: 组织单元架构](../architecture-decisions/ADR-004-organization-units-architecture.md) - 组织架构

### 实施指南
- [API重构指南](../implementation-guides/api-refactoring-2025/) - API重构实施方案
- [前端API集成](../implementation-guides/frontend-api-integration.md) - 前端集成指南

### 历史文档 (docs目录，仅参考)
- [架构文档](../../docs/architecture/) - 历史架构文档
- [测试指南](../../docs/testing/) - 测试相关文档
