...
func (r *PostgreSQLRepository) GetJobFamilyGroups(ctx context.Context, tenantID uuid.UUID, includeInactive bool, asOfDate *string) ([]model.JobFamilyGroup, error) {
...
`, whereClause)
	...
	var result []model.JobFamilyGroup
	for rows.Next() {
		var (
			item      model.JobFamilyGroup
			desc      sql.NullString
...
func (r *PostgreSQLRepository) GetJobFamilies(ctx context.Context, tenantID uuid.UUID, groupCode string, includeInactive bool, asOfDate *string) ([]model.JobFamily, error) {
...
`, whereClause)
	...
	var result []model.JobFamily
	for rows.Next() {
		var (
			item      model.JobFamily
			desc      sql.NullString
			endDate   sql.NullTime
			isCurrent bool
		)
...
func (r *PostgreSQLRepository) GetJobRoles(ctx context.Context, tenantID uuid.UUID, familyCode string, includeInactive bool, asOfDate *string) ([]model.JobRole, error) {
...
func (r *PostgreSQLRepository) GetJobLevels(ctx context.Context, tenantID uuid.UUID, roleCode string, includeInactive bool, asOfDate *string) ([]model.JobLevel, error) {
