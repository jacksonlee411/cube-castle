...
CREATE TABLE IF NOT EXISTS public.goose_db_version (
    ...
    CONSTRAINT goose_db_version_version_key UNIQUE (version_id)
);
INSERT INTO public.goose_db_version (version_id, is_applied)
VALUES (20251106000000, true)
ON CONFLICT (version_id) DO UPDATE SET is_applied = EXCLUDED.is_applied, tstamp = now();
-- +goose StatementEnd
