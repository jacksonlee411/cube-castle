...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'Parent organization 1000003 not found or inactive';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION 'Target organization 1000004 not found or inactive';
    END IF;
END
$$;
...
SELECT 'reparented 1000004 under 1000003' AS info, NOW() AS applied_at;
