...
- E2E Smoke（Live 小集合）：Chromium 通过（basic-functionality、simple-connection、organization-create）；证据：logs/plan222/playwright-LIVE-*.log
...
- E2E：logs/plan222/playwright-LIVE-20251115-140201.log
