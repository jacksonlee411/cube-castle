...
**创建日期**: 2025-11-03
**作者**: 架构组
**状态**: 执行中（Plan 211 Phase1 已完成，Phase2 准备就绪）
**最后更新**: 2025-11-04
**关联文档**:
...
> 2025-11-06 更新：Plan 210 数据库基线重建已完成，签字记录与执行说明详见 `docs/development-plans/210-database-baseline-reset-plan.md` 与 `docs/archive/development-plans/210-signoff-20251106.md`。
...
| **P0** | 迁移回滚 | ✅ Goose 基线 + up/down 可回滚（2025-11-06，见 Plan 210） | ✅ 100% 可回滚性（必须） | v4.8.0 |
