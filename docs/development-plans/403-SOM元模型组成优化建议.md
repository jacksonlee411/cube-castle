...
| 前端适配/Manifest | `frontend/src/features/temporal/**`、`scripts/generate-forms-from-openapi.js`、`scripts/generate-columns-from-graphql.js`、`logs/plan400/manifest/*.log` | 多视点与模块化建议若涉及前端，需指明使用现有 adapter/生成脚本，并更新 Manifest/Slot 与 obs 证据。 |
