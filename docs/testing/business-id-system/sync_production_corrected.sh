...
main() {
    ...
    VALUES 
        (gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'TECHNICAL',
         '边界职位9999999', 'POS_BOUNDARY', gen_random_uuid(), 'ACTIVE', 1.0, '9999999', 
         NOW(), NOW());
    " "插入边界测试职位"
    ...
    execute_sql "SELECT setval('org_business_id_seq', 51);" "更新组织序列"
    ...
    log_production "   • 组织数据: 51条 (ID范围: 100000-999999)"
    log_production "   • 职位数据: 101条 (ID范围: 1000000-9999999)"
    log_production "   • 总计: 653条记录"
    echo ""
